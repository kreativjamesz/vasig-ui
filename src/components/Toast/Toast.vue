  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        <div
          :class="cn(
            'flex items-start gap-2.5 min-w-[250px] max-w-[400px] p-3 rounded-lg shadow-lg bg-white dark:bg-gray-800 border pointer-events-auto',
            {
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            <div v-if="title" class="mb-0.5 text-xs font-semibold">{{ title }}</div>
          ...
          <button
            v-if="closable"
            @click="handleClose"
            class="flex-shrink-0 w-4 h-4 flex items-center justify-center opacity-50 hover:opacity-100 transition-opacity text-lg leading-none text-current"
