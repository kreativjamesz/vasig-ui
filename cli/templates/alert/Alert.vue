<template>
  <div
    :class="cn(
      'flex items-start gap-3 p-4 rounded-md border relative',
      {
  ...
  >
    ...
    <button
      v-if="closable"
      @click="handleClose"
      class="flex-shrink-0 w-5 h-5 flex items-center justify-center text-current opacity-70 hover:opacity-100 transition-opacity text-xl leading-none"
